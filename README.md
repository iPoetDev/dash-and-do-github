# [The Dash & Do GitHub Manager](https://github.com/ipoetdev/dash-and-do-for-github "Visit the GitHub project repository")


> Dash & Do GitHub Manager: A Dashboard (Reporting) and Do (Act or Automate) for GitHub Repositories

![Responsive: Dash & Do](  "Visit the live site on Heroku: htts://{appsslign}.herokuapp.com")
...
[![wakatime](https://wakatime.com/badge/user/2027c27d-0bab-4d7c-bfed-5d0b21285657/project/62c65141-830a-41c9-af92-98a9302fa984.svg)](https://wakatime.com/badge/user/2027c27d-0bab-4d7c-bfed-5d0b21285657/project/62c65141-830a-41c9-af92-98a9302fa984)  [WakaTime:](https://wakatime.com/@ipoetdev/projects/forvkqvyji)

[![JavaScript Style Guide](https://img.shields.io/badge/code_style-standard-brightgreen.svg)](https://standardjs.com)  [![linting: pylint](https://img.shields.io/badge/linting-pylint-yellowgreen)](https://github.com/pylint-dev/pylint)  [![security: bandit](https://img.shields.io/badge/security-bandit-yellow.svg)](https://github.com/PyCQA/bandit)  [![GitLeak protection ](/res/badges/gitleaks-badge.svg)](https://github.com/gitleaks/gitleaks)
...
- Use a *To-do and Action task manager* for the developer in response to the state of their repositories so that they can bulk edit on a single pane of glass pattern via a To Do and Tasker design. I.e. **The Do, aka Do & Act.**

#### 1.1.2 [Roadmap](#roadmap)

| Version | MVC Component | Apps    | Intent                                    | Pages                                              | Forms                   | API                   | Flows                                      | Dependencies   |
| ------- | ------------- | ------- | ----------------------------------------- | -------------------------------------------------- | ----------------------- | --------------------- | ------------------------------------------ | -------------- |
| 0.5     | MVC Minus     | Kore    | Index Page, Public, Private, Contact Form | Primary: Index (App), About (static), FAQ (static) | Contact                 |                       | Verify (1,2), Contact, Return Sessions (?) |                |
|         |               | Users   | Registration, Authentication              | Service: Verify, Error                             | Signup, Login, Reset(?) | GitHub Authentication | Sign Up (1), Login, Reset (2),             | Django AllAuth |
|         |               | Profile | User Details, GitHub Profile              |                                                    | User, Github            | GitHub Authentication |                                            |                |
|         |               |         |                                           |                                                    |                         |                       |                                            |                |
| 1.0     | MVC           | Dash    | Dashboard (Analaysis, Reoprting )         |                                                    |                         | GitHub Data APIs      |                                            |                |
|         |               |         |                                           |                                                    |                         |                       |                                            |                |
| 1.5     | MVC+          | Do      | Actions, Task, Bulk Edits                 |                                                    |                         | GitHub Data APIs      |                                            |                |
|         |               |         |                                           |                                                    |                         |                       |                                            |                |

#### 1.1.2 [Project Goals](#project-goals)

| Requestor/Audience    | Scope      | Goal                                                                                                                                                                                 |
| --------------------- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `Client`/`Assessor`   | `RFP`      | To build a full-stack site based on business logic used to control a centrally owned dataset.                                                                                        |
| `Client`/`Assessor`   | `RFP`      | To set up an authentication mechanism and provide role-based access to the site's data or other activities based on the dataset.                                                     |
| `Developer`           | `Solution` | To integrate GitHub with the Web App via GitHub social login and authentication tokens, with full lifecycle account management, via onboarding and offboarding of this social login. |
|                       | `Solution` | To authorized and grant permissions to the web app, as a 3rd party `service/integration`, to one's own GitHub account or, maybe, a secondary one.                                    |
|                       | `Solution` | To use GitHub API to perform the following:                                                                                                                                          |
|                       | `Solution`  | Analyse and graphically report on Languages used.                                                                                                                                    |
|                       | `Solution` | Analyse and graphically report on File Types used.                                                                                                                                   |
|                       | `Solution` | Analyse and collated the labels used across all accounts                                                                                                                             |
|                       | `Solution` | - CRUD and manipulate Issue Labels in bulk, centrally and apply to `all/selected` repositories in bulk.                                                                              |
|                       | `Solution` | - Copy and Apply a central store of common file types to to `all/selected` repositories in bulk.                                                                                     |
| `Client` / `Assessor` | `Project`  | To use agile methodologies and tooling to deliver the `Solution` to the `Client/Assessor`: <strong>Client Institute</strong>                                                                                            |

<small><strong><code>RFP</code></strong>: Request for Proposals: Assessments Requiremennts  || <strong><code>Solution</code></strong> Concept Goals  ||  <strong><code>Project</code></strong>: Project Management Goals/Requirements</small>
***
...
| Brand Name | | Repository | | Repository UL |
| ---------- | ---  |---------- | --- | ------------- |
...
-   The author-developer needs a problem in search of a solution for an academic assignment, and as such is extending the GitHub concepts where they see dis-benefits or constraints in functionality.
-   The author-developer is sticking to what they know in a familiar domain, GitHub, and is seeking to deepen their knowledge and capacity in this platform. This they seek to showcase this in this project.
...
| Choice            | Why                                                                                                       | Approach                                             | Is Not |
| ----------------- | --------------------------------------------------------------------------------------------------------- | ---------------------------------------------------- | ------ |
| Agile Methodology | Proscribed by the Client: The Code Institute                                                              | Breaks project into iterative phases (i.e. sprints). |        |
|                   | Is part of their software project portfolio development series in portfolio project 4: Full Stack Toolkit |  Emphasizes continuous adaption, adjustment to change, improvement, releases and customer feedback. |        |
|                   |                                                                                                           |   It's a cycle of flexible planning, execution and evaluation. |        |
|                   |                                                                                                           | Is customised for a solo developer. | A collaborative approach for this solo project. |
|                   |                                                                                                           |                                                      |        |
...
- The author/developer choose for using a 3rd party Project Management Tool: .  

| Tool                        | Features                                                | Constraints | Remedies |
| --------------------------- | -------------------------------------------------------- | ------------ | -------- |
| [zube.io](https://zube.io/) | Has [Agile Components](https://zube.io/docs/components). | Requires either a known Gmail account or a known GitHub to sign up. | Creates a custom email domain/account |
...
|                             | Integrates and synchronises with GitHub Issues. |  Does not use GitHub Project features | Use of GitHub Templates, with custom Agile artefacts/formats |
...
- Remedy for using a identifiable social account identifiers are :
    - By constraint, there is no common inbox for assessors to issue an onboarding email.
    - Creates a custom email domain/account as 
...
##### 3.2.1.1 Project Access | Assessor User

| Assessor ID | Email Address | Password | Web Mail Access | Is Django Admin User | Same Password | Notes |
| ------------ | ------------- | -------- | --------------- | -------------------- | ------------- | ----- |
| assessor@dash-and-do.xyz  | assessor@dash-and-do.xyz | Submitted with Submission Form | [https://mail1.netim.hosting/webmail/](https://mail1.netim.hosting/webmail/) | assessor@dash-and-do.xyz  | Yes, Same |       |

##### 3.2.1.2 Zube.io Benefits
...
- Uses a points system (Criteria: Merit: 1.5: User Stories, Points & Timeboxes prioritisations)
    ...
    - Employs a relative
      sizing, [see here: Practical Fibonacci: A Beginner's Guide to Relative Sizing | Scrum.org](https://www.scrum.org/resources/blog/practical-fibonacci-beginners-guide-relative-sizin
...
| Semantics🔽 ▶    | **Zero Points**                                                                                | **1-2 Points**                                                         | **3 Points**                                                           | **5 Points**                                                                  | **8 Points**                                                                  | **13 Points**                                                                                                                                                     |     |
| ---------------- | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------ | ------------------------------------------------------------------ | ------------------------------------------------------------------------- | ------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- | --- |
| **Complexity**       | No Effort                                                                                  | Extra Small (1) / Small (2)                                        | Average (3)                                                        | Large (5)                                                                 | Extra Large (8)                                                           | Warning (13)                                                                                                                                                  |     |
| **Value**  | No Effort Required, or there is some effort required, but there is no business value delivered, so no Points are accumulated for doing the work.  |  Developers consider it relatively easy, probably smallest items in the Sprint, and mostly likely completed in one day. | Developer(s) have done this a lot; knows what needs to be done.    |  Most Developers will need assistance from someone else. This is probably one of the largest items that can becompleted within a Sprint.  | Is going to take some time and research. Will take more than 1 developer to complete within two weeks. Plus: Developer need to make several assumptions that increase the risk. Likely to impact getting it Done. | Requires multiple assumptions to size. It is too much to complete in one Sprint. Instead, split this into multiple Items that can be completed independently. |     |
| **Risk/Uncertainty** | No Uncertainty                                                                             |                                                                    |  A Little                                                            | A Little                                                                     |                                                                           | A Lot |     |
| **Scoring**          | <ins>0 pts: NO EFFORT: Very Easy (0) // No Uncertainty (0)</ins>                           | <ins>1 pts: EXTRA SMALL: Very Easy (1) // No Uncertainty (1)</ins> | <ins>3 pts: AVERAGE: Medium (3) // No Uncertainty (1)</ins>        | <ins>5 pts: LARGE: Medium (5) // No Uncertainty (1)</ins>                 | <ins>8 pts: EXTRA LARGE: Hard Complexity (8) // No Uncertainty (1)</ins>  | <ins>13 pts: WARNING: Hard Complexity (13) // Low Uncertainty (1)</ins>                                                                                       |     |
|                  | -                                                                                           | <ins>2 pts: SMALL: Very Easy (1) // Little Uncertainty (2)</ins>   | <ins>3 pts: AVERAGE: Very Easy (1) // Little Uncertainty (3)</ins> | <ins>5 pts: LARGE: Easy, Low Complexity (1) // Some Uncertainty (5)</ins> | <ins>8 pts: LARGE: Easy, Low Complexity (1) // High Uncertainty (8)</ins> | <ins>13 WARNING: Easy, Low Complexity (1) // High Uncertainty (13)</ins>                                                                                      |     |
|                  | -                                                                                            | <ins>2 pts: SMALL: Medium (2) // No Uncertainty (1)</ins>          |  -                                                                  | -                                                                          | -                                                                          | -                                                                                                                                                              |     |
| **T-Shirt Sizing**                 |      XX-Small                                                                                      |  X-Small/Small                                                                  |  Mediium                                                                  | Large                                                                          |  X-Large                                                                         | XX-Large                                                                                                                                                              |     |
...
- Delivered by [GitHub Issue Template selector](https://github.com/iPoetDev/dash-and-do-github/issues/new/choose): and Zube.io..
- WORKFLOW: Flows are processes and step wise tutorials to complete a task/goal..
- NOT USING **GitHub Projects**.

| Artefact Step | Artefact                                                      | Intent                                                                     | Stage              | Influences                  | Template URL                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | More                                         |  README Chapter    |     |     |     |     |     |
| ------------- | ------------------------------------------------------------- | -------------------------------------------------------------------------- | ------------------ | --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------- | --- | 
| 00            | 00 DEFINE: Document / Readme                                  | Readme Development.   // Document / Effort / Concept.                      | Project            | _Readme Driven Development_ | [00 DEFINE: Document, Readme](https://github.com/iPoetDev/dash-and-do-github/issues/new?assignees=&labels=&projects=&template=00-define--document---readme.md&title=)                                                                                                                                                                                                                                                                                                                                                                                                                       |                                              | 
| 00            | 00 REQUIRE: Product, Agile Specification                      | Product Requirements & Agile Specifications                                | Product            | _Dash & Do GitHub's Wiki_   | [00 REQUIRE: Product, Agile Specification](https://github.com/iPoetDev/dash-and-do-github/issues/new?assignees=iPoetDev&labels=Kind%3A+Define%2C+Kind%3A+Refine&projects=&template=00-require--product---agile-specification.md&title=DEFINE+%3A%3A+)                                                                                                                                                                                                                                                                                                                                       |                                              |     | 
| 00            | 00 FLOW: Workflow, Process, Checklist                         | Best Practice, Strategic, Tactical Workflow                                | Project            |                             | [00 FLOW: Workflow,  Process, Checklist](https://github.com/iPoetDev/dash-and-do-github/issues/new?assignees=iPoetDev&labels=Deadline%3A+Oct+21%2C+Mentor%3A+1st+Review%3A+Aug+07%2C+Mentor%3A+2nd+Review%3A+%3A+Sep+04%2C+Mentor%3A+3rd+Review%3A+Oct+02%2C+Project+%3A+Inventory&projects=&template=00-flow--workflow---process---checklist.md&title=FLOW+%3A%3A+)                                                                                                                                                                                                                        |                                              |     |     |     |     |     |     |
| 00            | 00 SPRINT: Plan & Report                                      | New Sprint for sprint planning/tracking                                    | Agile/Plan         |                             | [00 SPRINT: Plan & Report](https://github.com/iPoetDev/dash-and-do-github/issues/new?assignees=iPoetDev&labels=Kind%3A+Sprint%2C+Plan+%3A+Horizon%2C+Plan+%3A+Sprint%2C+Sprint+01+%3A+The+First+Config%2C+Sprint+02+%3A+Arch+n+Deploy%2C+W%2FE%3A+Aug+04%2C+W%2FE%3A+Aug+11%2C+W%2FE%3A+Aug+18%2C+W%2FE%3A+Aug+25%2C+W%2FE%3A+Jul+14%2C+W%2FE%3A+Jul+21%2C+W%2FE%3A+Jul+28%2C+W%2FE%3A+Oct+07%2C+W%2FE%3A+Oct+14%2C+W%2FE%3A+Oct+21%2C+W%2FE%3A+Sep+08%2C+W%2FE%3A+Sep+15%2C+W%2FE%3A+Sep+22%2C+W%2FE%3A+Sep+29&projects=&template=00-sprint--plan---report.md&title=%5BSPRINT%5D++%3A%3A+) |                                              |     |
| 01            | 01 ADR: ADR Full Record                                       | Full Tracing of Why & Motivations. Key Decisions and Derivations           | Decisions          | _Any Decision Record_       | [01: ADR Full](https://github.com/iPoetDev/dash-and-do-github/issues/new?assignees=iPoetDev&labels=&projects=&template=01--adr-full.md&title=ADR000%3F+%3A%3A+)                                                                                                                                                                                                                                                                                                                                                                                                                             | Decisions: Architectural, Design, Technical. |     |
| 02            | 02 ADR: Y-Statement                                           | ADR Short forms, Problems Statements and Choices                           | Decisions          | _Y-Statements_              | [02 ADR-Y-Statement]()                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |                                              |     |     |     |     |     |     |
| 03            | 03 MILESTONE: Increments, Epic's Sprints                              | Plannable Increment or Grouping of Effort. Comprised of Features, User Stories & Enabler Tasks | Agile/Plan         |                             | [Dash & Do GitHub's Milestone](https://github.com/iPoetDev/dash-and-do-github/milestones)| Using Milestones for Agile Issue Tracking: Epics, Features, Stories etc Issues |     | 
| 03            | 03 EPIC: Feature, Infrastructure                              | A chapter of deliverable work. Comprised of Features, User Stories & Enabler Tasks | Agile/Plan         |                             |[03 EPIC: Requirement, Features, Infrastructure](https://github.com/iPoetDev/dash-and-do-github/issues/new?assignees=iPoetDev&labels=&projects=&template=03-epic--feature---infrastructure.md&title=EPIC000%3F+%3A%3A++)|                                              |     | 
| 04            | 04 FEAT: Feature, Component                                   | RFC: An Epic's Feature. An Epic's Component. | Agile/Plan         |                             |[04 FEAT: Feature, Component](https://github.com/iPoetDev/dash-and-do-github/issues/new?assignees=iPoetDev&labels=&projects=&template=04-feat--feature---component.md&title=FEAT+%3A%3A+)|                                              |     |
| 05            | 05 STORY: User Story, Use Case                                | An Epic's Task, an Use Case's subset. An enabling task linked to a Feature, Component | Agile/Plan         |                             | [05 STORY: User Story , Use Case](https://github.com/iPoetDev/dash-and-do-github/issues/new?assignees=iPoetDev&labels=&projects=&template=05-story--user-story----use-case.md&title=STORY-000%3F+%3A%3A+)|                                              |     |
| 06            | 06 ACCEPT: User Acceptance Criteria                           | UAC: Scenario, Feature, `Given ... When ... Then`  | Agile/Plan/Quality |                             |[06 ACCEPT: User Acceptance Criteria](https://github.com/iPoetDev/dash-and-do-github/issues/new?assignees=iPoetDev&labels=&projects=&template=06-accept--user-acceptance-criteria.md&title=UAC-000%3F+%3A%3A)|                                              |     |     |
| 07            | 07 CHECK: Static Analysis                                     | Pre-commit, Lint Report, Static Analysis,  W3C HTML & W3C CSS              | Agile/Plan/Test    |                             | [07 CHECK: Static Analysis](https://github.com/iPoetDev/dash-and-do-github/issues/new?assignees=iPoetDev&labels=&projects=&template=07-check--static-analysis.md&title=%5BCHECK+%7C+LINT%5D+%3A%3A+)                                                                                                                                                                                                                                                                                                                                                                                        |                                              |     |
| 07            | 07 BUG: Exception, Issue, Usability, Function, Responsiveness | Code Exception, Testing Issue, UI/UX Concern, UAT Issue                    | Quality/Test       |                             | [07 BUG: Exception, Issue, Usability, Function, Responsiveness](https://github.com/iPoetDev/dash-and-do-github/issues/new?assignees=iPoetDev&labels=&projects=&template=07-bug--exception---issue---usability---function---responsiveness.md&title=BUG+%3A%3A+++)                                                                                                                                                                                                                                                                                                                           |                                              |     |
| 08            | 08 TEST: Feature/Scenario/UAT, BDD                            | Behaviour Driven Development, Manual Feature Testing                       | Quality/Test       |                             | [08 TEST: Test Case, UAT, BDD](https://github.com/iPoetDev/P4Template/issues/new?assignees=iPoetDev&labels=&projects=&template=08-test--test-case---tdd--.md&title=%5BTEST%2FTDD%5D)                                                                                                                                                                                                                                                                                                                                                                                                        |                                              |     ||
| 09            | 09 DONE: Definition of Done                                   | Effort and UAC for Final Release & Delivery                                | Agile/Quality      | _Dash & Do GitHub's Wiki_     | [09 DONE: Definition of Done ](https://github.com/iPoetDev/dash-and-do-github/issues/new?assignees=iPoetDev&labels=&projects=&template=09-done--definition-of-done-.md&title=DONE%3A+)                                                                                                                                                                                                                                                                                                                                                                                                      |                                              |     | 
| 10            | 10 CONFIG: Linting, Static Analysis, Common Setups            | Tooling: Linting, Static Analysis. Common Setups: Well Known Configuration | Config             |                             | [10 CONFIG: Linting, Static Analysis, Common Setups)](https://github.com/iPoetDev/dash-and-do-github/issues/new?assignees=iPoetDev&labels=&projects=&template=09-config--linting---static-analysis---common-setups.md&title=CONFIG+%3A%3A+)                                                                                                                                                                                                                                                                                                                                                 |                                              |     | 
| 11            | 11 IMPEDE: Project Level Impediments                          | Project Impediment, Epic level blockers & issues.                          | Project            |                             | [11 IMPEDE: Project Level Impediments](https://github.com/iPoetDev/dash-and-do-github/issues/new?assignees=iPoetDev&labels=Project%3A+Impediment&projects=&template=11-impede--project-level-impediments.md&title=IMPEDE%3A+Project+Blocker%3A+)                                                                                                                                                                                                                                                                                                                                            |                                              |     |  
...
> The concept for Dash and Do GitHub Portfolio Manager can be decomposed into 
> 1. Real World Domain
> 2. Target Audiences
> 3. Web App Capabilities
> 4. Real User Frustrations
> 5. Real World Solution and Idea.

**The concept of a GitHub Portfolio Manager turns on the idea to at an account level, and not at per repository level, to manage, take a snapshot of the accounts' repositories status and apply certain limited features consistently across all repositories at once in bulk. This employs a single pane of glass paradigm to manage the GitHub over one page. To achieve this, it takes on a web app, similar like a desktop app, using a single page architecture and per component interaction design. It avoids, where possible, the per page reloading/redirection and refreshes that comes with traditional multi-page web architectures. **

### 4.1. [Real World Domain](#domain)

| Domain                      | Data Sources,  Real World                      | Outline                                                                                                   |     |
| --------------------------- | --------------------------------- | --------------------------------------------------------------------------------------------------------- | --- |
| ***Domain***                | GitHub.com                        | GitHub.com as a software development, source control and deployment collaboration platform.               |     |
| ***Data Domain***           | GitHub API                        |                                                                                                           |     |
| ***Account Access***        | Personal Developer GitHub Account | A Personal Developer seeking to manage, report and make bulk changes/automations to their GitHub Account. |     |
| ***Security Domain***       | GitHub Access Tokens and API Keys |                                                                                                           |     |
| ***Platform as a Service*** | Heroku                            |                                                                                                           |     |
| ***Database as a Service*** | ElephantSQL PostgressSQL          |                                                                                                           |     |
| ***Email as a Service***    | MailerToGo    |  Via Heroku Addon                                                                                                         |     |
| ***Email Domain (MX) & Hosting***                          | [dash-and-do.xyz, by Netim Hosting](https://mail1.netim.hosting/webmail/)  | Using a custom email/MX domain for email configuration and for control of reviewer and for testing purpose.                                                                                                          |     |
...
| Audience                | Type           | Focus |  Actioons   | Goals    |     |
| ----------------------- | -------------- | ------- | --- | --- | --- |
| Developers              | Core           | Target  |     |     |     |
| Junior Developers       | Sub-Cohort     |         |     |     |     |
| Open Source Maintainers | Sub-Cohort     |         |     |     |     |
| Software Managers       | Target Readers | Auxiliary   |     |     |     |
| Hiring Manager          | Sub-Cohort     |         |     |     |     |
| Repo Managers           | Sub-Cohort     |         |     |     |     |
...
This comes from the author/developer’s personal experience and frustrations. Given others’ comments in the Code Institute, this may not be an isolated experience.
...
###  5.1 [Project & Assignment Scope](#project-scope)

| **<ins>Pre-Conditions</ins>**                                              | **<ins>Assumptions</ins>** | **<ins>Constraints</ins>** | **<ins>Compatibility</ins>** |
| ----------------------------------------------------------- | ----------- | ----------- | ------------- |
| The Project & Solution is delivered in an *academic context*. |  It is assumed the developer is a student with no prior experience, at a minimum. | An Agile Methodology is **mandated**, using Epic and User Stories as key artefacts. | The application design for the web is further constrained by it's available global or local audience and their install-base of a browser. |
| The Project & Solution is delivered inside a predefined timeboxed _scope of 3-4 months_. | It is assumed that the student developer has attempted HTML & CSS Essentials, JavaScript Essentials and Python Essentials. | HTML, CSS and JavaScript are _recommended_ front-end technologies. | Browser compatibility is a essential aspect of a web application as the browser is the fundamental web application end-point |
| The Project is managed within the scope of an *Agile project management* methodology. | It is assumed that the student developer comprehends and can produced a deliverable that is a minimally viable product. | Python and Django (web framework) are _recommended_ back-end technologies. | Developer tools, like Auto-fixer (which tailwind recommends for applying browser vendor pre-fixes) aid in ensuring code compatibility and quality with Browsers. |
| The Deliverable is assessed and graded to a predefined evaluation schema and criteria. | It is assumed that the student developer can deliver the deliverable within the allocated and predefined timeboxed scope of 3 months. |  Model View Controller is a _recommended_ architectural design pattern, a code factoring principle. That CRUD as a data manipulation pattern is **mandated**. | So using these two services will aid the developer experience and ultimately the user experience. |
