// https://unpkg.com/htmx.org@1.9.4/dist/htmx.min.js
;(function (e, t) {
    ...
    return (function () {
        ...
        function Ke(e) {
            return (
                location.hostname === e.hostname && J(e, 'href') && J(e, 'href').indexOf('#') !== 0
            )
        }
        function Ye(t, r, e) {
            if (
                (t.tagName === 'A' && Ke(t) && (t.target === '' || t.target === '_self')) ||
                t.tagName === 'FORM'
            ) {
                r.boosted = true
                var n, i
        ...
        function et(e, t) {
            return (
                ee(e).boosted && e.tagName === 'A' && t.type === 'click' && (t.ctrlKey || t.metaKey)
            )
        }
        function tt(e, t, r) {
            var n = e.eventFilter
